...
%\includegraphics[width = 0.8\paperwidth]{figures/regression_mehta_3.pdf} \\
%\includegraphics[width = 0.8\paperwidth]{figures/regression_mehta_4.pdf} \\
%\includegraphics[width = 0.8\paperwidth]{figures/regression_mehta_5.pdf} \\
...
%\includegraphics[width = 0.8\paperwidth]{figures/regression_mehta_9.pdf} \\
